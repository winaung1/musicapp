...
function Details() {
  ...
  return (
    ...
    {subCount?.items?.map(sub => {
        return <div className='rounded-xl mb-4 fixed top-32 left-10 tracking-widest z-[80000]'>
    ...
    <div className="pl-[240px] grid md:grid-cols-2 justify-end xl:grid-cols-3 gap-4 p-4">
    {data?.items?.map((item, index) => { 
      return <div className='rounded-2xl relative drop-shadow-2xl w-80' key={item.id.videoId}>
          ...
          <iframe className='rounded-2xl w-full' title='hello' 
